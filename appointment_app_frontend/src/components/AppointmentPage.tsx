...
import { D } from '@fullcalendar/core/internal-common.js'
...
function renderSidebarEvent(event: { id: React.Key | null | undefined; start: D; title: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined }) {
  return (
    <li key={event.id}>
